...
import { Users, TrendingUp, Calendar, BarChart2, List, Filter, X } from "lucide-react";
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                        <div className="p-5 border-b border-slate-100">
                            ...
                            {isFiltered && (
                                <p className="text-xs text-amber-600 mt-1">フィルター適用中 — {filteredTotal}件の回答を集計</p>
                            )}
                        </div>
                        <div className="divide-y divide-slate-100">
                            {activeStats.map((q: any, index: number) => (
