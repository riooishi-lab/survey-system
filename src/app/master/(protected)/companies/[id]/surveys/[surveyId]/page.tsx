...
import { getMasterSurveyResults } from "@/app/actions/master";
...
export default async function MasterSurveyResultsPage({
    params,
}: {
    ...
    const { data: survey, error } = await getMasterSurveyResults(id, surveyId);
        ...
        <div className="space-y-6 pb-12">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-slate-500 mt-1 text-sm">回答結果の閲覧</p>
                </div>
            </div>
